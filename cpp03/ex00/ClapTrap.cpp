...
/*   Updated: 2024/05/21 00:30:43 by babonnet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount) {
    std::cout << "ClapTrap " << _name << ": get attack and take " << amount
              << " damage!" << std::endl;
    if (_health > amount) {
        _health -= amount;
    } else {
...
void ClapTrap::setHealth(const unsigned int &value) {
    _health = value;
    std::cout << "ClapTrap " << _name << ": set is health to " << value
              << std::endl;
}
...
void ClapTrap::setAttackDamage(const unsigned &value) {
    std::cout << "ClapTrap " << _name << ": set is power to " << value
              << std::endl;
	_attackDamage = value;
}
